-- ANALYSIS OF FACEBOOK AND INSTAGRAM ADVERTS FOR JAN - APRIL 2022

-- Commands Used - SELECT, FROM, WHERE, ALTER TABLE, ALTER COLUMN, GROUP  BY, ORDER BY, MONTH, NESTED QUERIES
...
-- DATA CLEANING
-- Rename columns names appropriately via SQL Server design interface
...
-- KPI 1: Calculate the monthly growth rate for Facebook and Instagram audience reach.
...
-- KPI 3: Determine the total amount spent for Adverts on a monthly basis.
SELECT 
	DATENAME(MONTH, Date) AS MonthName,
...
-- KPI 4: Calculate the percentage increase or decrease of Amount spent for Adverts.
SELECT 
    MonthName,
     Total_Ad_Spend,
